...
const Sidebar: React.FC = () => {
    ...
    const menuItems = [
        { icon: Home, label: 'Home', path: '/dashboard', roles: ['admin', 'hr', 'manager', 'employee'] },
        { icon: UserPlus, label: 'Onboarding', path: '/onboarding', roles: ['admin', 'hr'] },
        { icon: CalendarDays, label: 'Time Off', path: '/leave', roles: ['admin', 'hr', 'manager', 'employee'] },
        { icon: Clock, label: 'Attendance', path: '/attendance', roles: ['admin', 'hr', 'manager', 'employee'] },
        { icon: Briefcase, label: 'Timesheet', path: '/timesheet', roles: ['admin', 'hr', 'manager', 'employee'] },
